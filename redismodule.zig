...
pub fn __darwin_fd_isset(_n: c_int, _p: [*c]const struct_fd_set) c_int {
...
pub extern fn renameat(arg0: c_int, arg1: [*c]const u8, arg2: c_int, arg3: [*c]const u8) c_int;
pub extern fn renamex_np(arg0: [*c]const u8, arg1: [*c]const u8, arg2: c_uint) c_int;
pub extern fn renameatx_np(arg0: c_int, arg1: [*c]const u8, arg2: c_int, arg3: [*c]const u8, arg4: c_uint) c_int;
...
pub const struct___sFILE = extern struct {
    ...
    _lbfsize: c_int,
    _cookie: ?*c_void,
    _close: ?extern fn(?*c_void) c_int,
    _read: ?extern fn(?*c_void, [*c]u8, c_int) c_int,
    _seek: ?extern fn(?*c_void, fpos_t, c_int) fpos_t,
    _write: ?extern fn(?*c_void, [*c]const u8, c_int) c_int,
    _ub: struct___sbuf,
...
pub extern fn clearerr(arg0: [*c]FILE) void;
pub extern fn fclose(arg0: [*c]FILE) c_int;
pub extern fn feof(arg0: [*c]FILE) c_int;
pub extern fn ferror(arg0: [*c]FILE) c_int;
pub extern fn fflush(arg0: [*c]FILE) c_int;
pub extern fn fgetc(arg0: [*c]FILE) c_int;
pub extern fn fgetpos(noalias arg0: [*c]FILE, arg1: [*c]fpos_t) c_int;
pub extern fn fgets(noalias arg0: [*c]u8, arg1: c_int, arg2: [*c]FILE) [*c]u8;
pub extern fn fopen(__filename: [*c]const u8, __mode: [*c]const u8) [*c]FILE;
pub extern fn fprintf(arg0: [*c]FILE, arg1: [*c]const u8, ...) c_int;
pub extern fn fputc(arg0: c_int, arg1: [*c]FILE) c_int;
pub extern fn fputs(noalias arg0: [*c]const u8, noalias arg1: [*c]FILE) c_int;
pub extern fn fread(__ptr: ?*c_void, __size: c_ulong, __nitems: c_ulong, __stream: [*c]FILE) c_ulong;
pub extern fn freopen(noalias arg0: [*c]const u8, noalias arg1: [*c]const u8, noalias arg2: [*c]FILE) [*c]FILE;
pub extern fn fscanf(noalias arg0: [*c]FILE, noalias arg1: [*c]const u8, ...) c_int;
pub extern fn fseek(arg0: [*c]FILE, arg1: c_long, arg2: c_int) c_int;
pub extern fn fsetpos(arg0: [*c]FILE, arg1: [*c]const fpos_t) c_int;
pub extern fn ftell(arg0: [*c]FILE) c_long;
pub extern fn fwrite(__ptr: ?*const c_void, __size: c_ulong, __nitems: c_ulong, __stream: [*c]FILE) c_ulong;
pub extern fn getc(arg0: [*c]FILE) c_int;
pub extern fn getchar() c_int;
pub extern fn gets(arg0: [*c]u8) [*c]u8;
pub extern fn perror(arg0: [*c]const u8) void;
pub extern fn printf(arg0: [*c]const u8, ...) c_int;
pub extern fn putc(arg0: c_int, arg1: [*c]FILE) c_int;
pub extern fn putchar(arg0: c_int) c_int;
pub extern fn puts(arg0: [*c]const u8) c_int;
pub extern fn remove(arg0: [*c]const u8) c_int;
pub extern fn rename(__old: [*c]const u8, __new: [*c]const u8) c_int;
pub extern fn rewind(arg0: [*c]FILE) void;
pub extern fn scanf(noalias arg0: [*c]const u8, ...) c_int;
pub extern fn setbuf(noalias arg0: [*c]FILE, noalias arg1: [*c]u8) void;
pub extern fn setvbuf(noalias arg0: [*c]FILE, noalias arg1: [*c]u8, arg2: c_int, arg3: usize) c_int;
pub extern fn sprintf(arg0: [*c]u8, arg1: [*c]const u8, ...) c_int;
pub extern fn sscanf(noalias arg0: [*c]const u8, noalias arg1: [*c]const u8, ...) c_int;
pub extern fn tmpfile() [*c]FILE;
pub extern fn tmpnam(arg0: [*c]u8) [*c]u8;
pub extern fn ungetc(arg0: c_int, arg1: [*c]FILE) c_int;
pub extern fn vfprintf(arg0: [*c]FILE, arg1: [*c]const u8, arg2: [*c]struct___va_list_tag) c_int;
pub extern fn vprintf(arg0: [*c]const u8, arg1: [*c]struct___va_list_tag) c_int;
pub extern fn vsprintf(arg0: [*c]u8, arg1: [*c]const u8, arg2: [*c]struct___va_list_tag) c_int;
pub extern fn ctermid(arg0: [*c]u8) [*c]u8;
pub extern fn fdopen(arg0: c_int, arg1: [*c]const u8) [*c]FILE;
pub extern fn fileno(arg0: [*c]FILE) c_int;
pub extern fn pclose(arg0: [*c]FILE) c_int;
pub extern fn popen(arg0: [*c]const u8, arg1: [*c]const u8) [*c]FILE;
pub extern fn __srget(arg0: [*c]FILE) c_int;
pub extern fn __svfscanf(arg0: [*c]FILE, arg1: [*c]const u8, arg2: [*c]struct___va_list_tag) c_int;
pub extern fn __swbuf(arg0: c_int, arg1: [*c]FILE) c_int;
pub extern fn flockfile(arg0: [*c]FILE) void;
pub extern fn ftrylockfile(arg0: [*c]FILE) c_int;
pub extern fn funlockfile(arg0: [*c]FILE) void;
pub extern fn getc_unlocked(arg0: [*c]FILE) c_int;
pub extern fn getchar_unlocked() c_int;
pub extern fn putc_unlocked(arg0: c_int, arg1: [*c]FILE) c_int;
pub extern fn putchar_unlocked(arg0: c_int) c_int;
pub extern fn getw(arg0: [*c]FILE) c_int;
pub extern fn putw(arg0: c_int, arg1: [*c]FILE) c_int;
...
pub extern fn vfscanf(noalias __stream: [*c]FILE, noalias __format: [*c]const u8, arg2: [*c]struct___va_list_tag) c_int;
pub extern fn vscanf(noalias __format: [*c]const u8, arg1: [*c]struct___va_list_tag) c_int;
pub extern fn vsnprintf(__str: [*c]u8, __size: c_ulong, __format: [*c]const u8, arg3: [*c]struct___va_list_tag) c_int;
pub extern fn vsscanf(noalias __str: [*c]const u8, noalias __format: [*c]const u8, arg2: [*c]struct___va_list_tag) c_int;
pub extern fn dprintf(arg0: c_int, noalias arg1: [*c]const u8, ...) c_int;
pub extern fn vdprintf(arg0: c_int, noalias arg1: [*c]const u8, arg2: [*c]struct___va_list_tag) c_int;
...
pub extern fn asprintf(noalias arg0: [*c]([*c]u8), noalias arg1: [*c]const u8, ...) c_int;
pub extern fn ctermid_r(arg0: [*c]u8) [*c]u8;
pub extern fn fgetln(arg0: [*c]FILE, arg1: [*c]usize) [*c]u8;
pub extern fn fmtcheck(arg0: [*c]const u8, arg1: [*c]const u8) [*c]const u8;
pub extern fn fpurge(arg0: [*c]FILE) c_int;
pub extern fn setbuffer(arg0: [*c]FILE, arg1: [*c]u8, arg2: c_int) void;
pub extern fn setlinebuf(arg0: [*c]FILE) c_int;
pub extern fn vasprintf(noalias arg0: [*c]([*c]u8), noalias arg1: [*c]const u8, arg2: [*c]struct___va_list_tag) c_int;
pub extern fn zopen(arg0: [*c]const u8, arg1: [*c]const u8, arg2: c_int) [*c]FILE;
pub extern fn funopen(arg0: ?*const c_void, arg1: ?extern fn(?*c_void, [*c]u8, c_int) c_int, arg2: ?extern fn(?*c_void, [*c]const u8, c_int) c_int, arg3: ?extern fn(?*c_void, fpos_t, c_int) fpos_t, arg4: ?extern fn(?*c_void) c_int) [*c]FILE;
pub extern fn __sprintf_chk(noalias arg0: [*c]u8, arg1: c_int, arg2: usize, noalias arg3: [*c]const u8, ...) c_int;
pub extern fn __snprintf_chk(noalias arg0: [*c]u8, arg1: usize, arg2: c_int, arg3: usize, noalias arg4: [*c]const u8, ...) c_int;
pub extern fn __vsprintf_chk(noalias arg0: [*c]u8, arg1: c_int, arg2: usize, noalias arg3: [*c]const u8, arg4: [*c]struct___va_list_tag) c_int;
pub extern fn __vsnprintf_chk(noalias arg0: [*c]u8, arg1: usize, arg2: c_int, arg3: usize, noalias arg4: [*c]const u8, arg5: [*c]struct___va_list_tag) c_int;
...
pub const struct_RedisModuleCommandFilterCtx = @OpaqueType();
pub const RedisModuleCommandFilterCtx = struct_RedisModuleCommandFilterCtx;
pub const struct_RedisModuleCommandFilter = @OpaqueType();
pub const RedisModuleCommandFilter = struct_RedisModuleCommandFilter;
pub const RedisModuleCmdFunc = ?extern fn(*RedisModuleCtx, [*c](*RedisModuleString), c_int) c_int;
pub const RedisModuleDisconnectFunc = ?extern fn(?*RedisModuleCtx, ?*RedisModuleBlockedClient) void;
pub const RedisModuleNotificationFunc = ?extern fn(?*RedisModuleCtx, c_int, [*c]const u8, ?*RedisModuleString) c_int;
...
pub const RedisModuleClusterMessageReceiver = ?extern fn(?*RedisModuleCtx, [*c]const u8, u8, [*c]const u8, u32) void;
pub const RedisModuleTimerProc = ?extern fn(?*RedisModuleCtx, ?*c_void) void;
pub const RedisModuleCommandFilterFunc = ?extern fn(?*RedisModuleCommandFilterCtx) void;
...
pub var RedisModule_Strdup: extern fn([*c]const u8) [*c]u8 = undefined;
pub var RedisModule_GetApi: ?extern fn([*c]const u8, ?*c_void) c_int = undefined;
pub var RedisModule_CreateCommand: extern fn(?*RedisModuleCtx, [*c]const u8, RedisModuleCmdFunc, [*c]const u8, c_int, c_int, c_int) c_int = undefined;
pub var RedisModule_SetModuleAttribs: ?extern fn(?*RedisModuleCtx, [*c]const u8, c_int, c_int) void = undefined;
pub var RedisModule_IsModuleNameBusy: ?extern fn([*c]const u8) c_int = undefined;
...
pub var RedisModule_Call: extern fn(?*RedisModuleCtx, [*c]const u8, [*c]const u8, ...) ?*RedisModuleCallReply = undefined;
pub var RedisModule_CallReplyProto: extern fn(?*RedisModuleCallReply, [*c]usize) [*c]const u8 = undefined;
...
pub var RedisModule_CreateString: extern fn(?*RedisModuleCtx, [*c]const u8, usize) ?*RedisModuleString = undefined;
...
pub var RedisModule_CreateStringPrintf: extern fn(?*RedisModuleCtx, [*c]const u8, ...) ?*RedisModuleString = undefined;
pub var RedisModule_FreeString: extern fn(?*RedisModuleCtx, ?*RedisModuleString) void = undefined;
pub var RedisModule_StringPtrLen: extern fn(?*const RedisModuleString, [*c]usize) [*c]const u8 = undefined;
pub var RedisModule_ReplyWithError: extern fn(?*RedisModuleCtx, [*c]const u8) c_int = undefined;
pub var RedisModule_ReplyWithSimpleString: extern fn(?*RedisModuleCtx, [*c]const u8) c_int = undefined;
...
pub var RedisModule_ReplyWithStringBuffer: extern fn(?*RedisModuleCtx, [*c]const u8, usize) c_int = undefined;
...
pub var RedisModule_StringToLongLong: extern fn(?*const RedisModuleString, [*c]c_longlong) c_int = undefined;
pub var RedisModule_StringToDouble: extern fn(?*const RedisModuleString, [*c]f64) c_int = undefined;
pub var RedisModule_AutoMemory: extern fn(?*RedisModuleCtx) void = undefined;
pub var RedisModule_Replicate: extern fn(?*RedisModuleCtx, [*c]const u8, [*c]const u8, ...) c_int = undefined;
pub var RedisModule_ReplicateVerbatim: extern fn(?*RedisModuleCtx) c_int = undefined;
pub var RedisModule_CallReplyStringPtr: extern fn(?*RedisModuleCallReply, [*c]usize) [*c]const u8 = undefined;
...
pub var RedisModule_StringDMA: extern fn(?*RedisModuleKey, [*c]usize, c_int) [*c]u8 = undefined;
...
pub var RedisModule_ZsetAdd: extern fn(?*RedisModuleKey, f64, ?*RedisModuleString, [*c]c_int) c_int = undefined;
pub var RedisModule_ZsetIncrby: extern fn(?*RedisModuleKey, f64, ?*RedisModuleString, [*c]c_int, [*c]f64) c_int = undefined;
pub var RedisModule_ZsetScore: extern fn(?*RedisModuleKey, ?*RedisModuleString, [*c]f64) c_int = undefined;
pub var RedisModule_ZsetRem: extern fn(?*RedisModuleKey, ?*RedisModuleString, [*c]c_int) c_int = undefined;
...
pub var RedisModule_ZsetRangeCurrentElement: extern fn(?*RedisModuleKey, [*c]f64) ?*RedisModuleString = undefined;
...
pub var RedisModule_CreateDataType: extern fn(?*RedisModuleCtx, [*c]const u8, c_int, [*c]RedisModuleTypeMethods) ?*RedisModuleType = undefined;
...
pub var RedisModule_EmitAOF: extern fn(?*RedisModuleIO, [*c]const u8, [*c]const u8, ...) void = undefined;
pub var RedisModule_SaveString: extern fn(?*RedisModuleIO, ?*RedisModuleString) void = undefined;
pub var RedisModule_SaveStringBuffer: extern fn(?*RedisModuleIO, [*c]const u8, usize) void = undefined;
pub var RedisModule_LoadString: extern fn(?*RedisModuleIO) ?*RedisModuleString = undefined;
pub var RedisModule_LoadStringBuffer: extern fn(?*RedisModuleIO, [*c]usize) [*c]u8 = undefined;
...
pub var RedisModule_Log: extern fn(?*RedisModuleCtx, [*c]const u8, [*c]const u8, ...) void = undefined;
pub var RedisModule_LogIOError: extern fn(?*RedisModuleIO, [*c]const u8, [*c]const u8, ...) void = undefined;
pub var RedisModule_StringAppendBuffer: extern fn(?*RedisModuleCtx, ?*RedisModuleString, [*c]const u8, usize) c_int = undefined;
...
pub var RedisModule_GetKeyNameFromIO: extern fn(?*RedisModuleIO) ?*const RedisModuleString = undefined;
pub var RedisModule_Milliseconds: extern fn() c_longlong = undefined;
pub var RedisModule_DigestAddStringBuffer: extern fn(?*RedisModuleDigest, [*c]u8, usize) void = undefined;
...
pub var RedisModule_DictGetC: extern fn(?*RedisModuleDict, ?*c_void, usize, [*c]c_int) ?*c_void = undefined;
pub var RedisModule_DictGet: extern fn(?*RedisModuleDict, ?*RedisModuleString, [*c]c_int) ?*c_void = undefined;
...
pub var RedisModule_DictIteratorStartC: extern fn(?*RedisModuleDict, [*c]const u8, ?*c_void, usize) ?*RedisModuleDictIter = undefined;
pub var RedisModule_DictIteratorStart: extern fn(?*RedisModuleDict, [*c]const u8, ?*RedisModuleString) ?*RedisModuleDictIter = undefined;
pub var RedisModule_DictIteratorStop: extern fn(?*RedisModuleDictIter) void = undefined;
pub var RedisModule_DictIteratorReseekC: extern fn(?*RedisModuleDictIter, [*c]const u8, ?*c_void, usize) c_int = undefined;
pub var RedisModule_DictIteratorReseek: extern fn(?*RedisModuleDictIter, [*c]const u8, ?*RedisModuleString) c_int = undefined;
pub var RedisModule_DictNextC: extern fn(?*RedisModuleDictIter, [*c]usize, [*c](?*c_void)) ?*c_void = undefined;
pub var RedisModule_DictPrevC: extern fn(?*RedisModuleDictIter, [*c]usize, [*c](?*c_void)) ?*c_void = undefined;
pub var RedisModule_DictNext: extern fn(?*RedisModuleCtx, ?*RedisModuleDictIter, [*c](?*c_void)) ?*RedisModuleString = undefined;
pub var RedisModule_DictPrev: extern fn(?*RedisModuleCtx, ?*RedisModuleDictIter, [*c](?*c_void)) ?*RedisModuleString = undefined;
pub var RedisModule_DictCompareC: extern fn(?*RedisModuleDictIter, [*c]const u8, ?*c_void, usize) c_int = undefined;
pub var RedisModule_DictCompare: extern fn(?*RedisModuleDictIter, [*c]const u8, ?*RedisModuleString) c_int = undefined;
pub fn RedisModule_Init(ctx: ?*RedisModuleCtx, name: [*c]const u8, ver: c_int, apiver: c_int) c_int {
    ...
    _ = RedisModule_GetApi.?(c"RedisModule_Alloc", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_Alloc)));
    _ = RedisModule_GetApi.?(c"RedisModule_Calloc", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_Calloc)));
    _ = RedisModule_GetApi.?(c"RedisModule_Free", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_Free)));
    _ = RedisModule_GetApi.?(c"RedisModule_Realloc", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_Realloc)));
    _ = RedisModule_GetApi.?(c"RedisModule_Strdup", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_Strdup)));
    _ = RedisModule_GetApi.?(c"RedisModule_CreateCommand", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_CreateCommand)));
    _ = RedisModule_GetApi.?(c"RedisModule_SetModuleAttribs", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_SetModuleAttribs)));
    _ = RedisModule_GetApi.?(c"RedisModule_IsModuleNameBusy", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_IsModuleNameBusy)));
    _ = RedisModule_GetApi.?(c"RedisModule_WrongArity", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_WrongArity)));
    _ = RedisModule_GetApi.?(c"RedisModule_ReplyWithLongLong", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ReplyWithLongLong)));
    _ = RedisModule_GetApi.?(c"RedisModule_ReplyWithError", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ReplyWithError)));
    _ = RedisModule_GetApi.?(c"RedisModule_ReplyWithSimpleString", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ReplyWithSimpleString)));
    _ = RedisModule_GetApi.?(c"RedisModule_ReplyWithArray", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ReplyWithArray)));
    _ = RedisModule_GetApi.?(c"RedisModule_ReplySetArrayLength", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ReplySetArrayLength)));
    _ = RedisModule_GetApi.?(c"RedisModule_ReplyWithStringBuffer", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ReplyWithStringBuffer)));
    _ = RedisModule_GetApi.?(c"RedisModule_ReplyWithString", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ReplyWithString)));
    _ = RedisModule_GetApi.?(c"RedisModule_ReplyWithNull", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ReplyWithNull)));
    _ = RedisModule_GetApi.?(c"RedisModule_ReplyWithCallReply", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ReplyWithCallReply)));
    _ = RedisModule_GetApi.?(c"RedisModule_ReplyWithDouble", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ReplyWithDouble)));
    _ = RedisModule_GetApi.?(c"RedisModule_ReplySetArrayLength", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ReplySetArrayLength)));
    _ = RedisModule_GetApi.?(c"RedisModule_GetSelectedDb", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_GetSelectedDb)));
    _ = RedisModule_GetApi.?(c"RedisModule_SelectDb", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_SelectDb)));
    _ = RedisModule_GetApi.?(c"RedisModule_OpenKey", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_OpenKey)));
    _ = RedisModule_GetApi.?(c"RedisModule_CloseKey", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_CloseKey)));
    _ = RedisModule_GetApi.?(c"RedisModule_KeyType", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_KeyType)));
    _ = RedisModule_GetApi.?(c"RedisModule_ValueLength", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ValueLength)));
    _ = RedisModule_GetApi.?(c"RedisModule_ListPush", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ListPush)));
    _ = RedisModule_GetApi.?(c"RedisModule_ListPop", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ListPop)));
    _ = RedisModule_GetApi.?(c"RedisModule_StringToLongLong", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_StringToLongLong)));
    _ = RedisModule_GetApi.?(c"RedisModule_StringToDouble", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_StringToDouble)));
    _ = RedisModule_GetApi.?(c"RedisModule_Call", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_Call)));
    _ = RedisModule_GetApi.?(c"RedisModule_CallReplyProto", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_CallReplyProto)));
    _ = RedisModule_GetApi.?(c"RedisModule_FreeCallReply", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_FreeCallReply)));
    _ = RedisModule_GetApi.?(c"RedisModule_CallReplyInteger", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_CallReplyInteger)));
    _ = RedisModule_GetApi.?(c"RedisModule_CallReplyType", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_CallReplyType)));
    _ = RedisModule_GetApi.?(c"RedisModule_CallReplyLength", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_CallReplyLength)));
    _ = RedisModule_GetApi.?(c"RedisModule_CallReplyArrayElement", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_CallReplyArrayElement)));
    _ = RedisModule_GetApi.?(c"RedisModule_CallReplyStringPtr", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_CallReplyStringPtr)));
    _ = RedisModule_GetApi.?(c"RedisModule_CreateStringFromCallReply", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_CreateStringFromCallReply)));
    _ = RedisModule_GetApi.?(c"RedisModule_CreateString", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_CreateString)));
    _ = RedisModule_GetApi.?(c"RedisModule_CreateStringFromLongLong", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_CreateStringFromLongLong)));
    _ = RedisModule_GetApi.?(c"RedisModule_CreateStringFromString", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_CreateStringFromString)));
    _ = RedisModule_GetApi.?(c"RedisModule_CreateStringPrintf", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_CreateStringPrintf)));
    _ = RedisModule_GetApi.?(c"RedisModule_FreeString", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_FreeString)));
    _ = RedisModule_GetApi.?(c"RedisModule_StringPtrLen", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_StringPtrLen)));
    _ = RedisModule_GetApi.?(c"RedisModule_AutoMemory", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_AutoMemory)));
    _ = RedisModule_GetApi.?(c"RedisModule_Replicate", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_Replicate)));
    _ = RedisModule_GetApi.?(c"RedisModule_ReplicateVerbatim", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ReplicateVerbatim)));
    _ = RedisModule_GetApi.?(c"RedisModule_DeleteKey", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DeleteKey)));
    _ = RedisModule_GetApi.?(c"RedisModule_UnlinkKey", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_UnlinkKey)));
    _ = RedisModule_GetApi.?(c"RedisModule_StringSet", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_StringSet)));
    _ = RedisModule_GetApi.?(c"RedisModule_StringDMA", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_StringDMA)));
    _ = RedisModule_GetApi.?(c"RedisModule_StringTruncate", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_StringTruncate)));
    _ = RedisModule_GetApi.?(c"RedisModule_GetExpire", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_GetExpire)));
    _ = RedisModule_GetApi.?(c"RedisModule_SetExpire", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_SetExpire)));
    _ = RedisModule_GetApi.?(c"RedisModule_ZsetAdd", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ZsetAdd)));
    _ = RedisModule_GetApi.?(c"RedisModule_ZsetIncrby", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ZsetIncrby)));
    _ = RedisModule_GetApi.?(c"RedisModule_ZsetScore", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ZsetScore)));
    _ = RedisModule_GetApi.?(c"RedisModule_ZsetRem", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ZsetRem)));
    _ = RedisModule_GetApi.?(c"RedisModule_ZsetRangeStop", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ZsetRangeStop)));
    _ = RedisModule_GetApi.?(c"RedisModule_ZsetFirstInScoreRange", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ZsetFirstInScoreRange)));
    _ = RedisModule_GetApi.?(c"RedisModule_ZsetLastInScoreRange", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ZsetLastInScoreRange)));
    _ = RedisModule_GetApi.?(c"RedisModule_ZsetFirstInLexRange", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ZsetFirstInLexRange)));
    _ = RedisModule_GetApi.?(c"RedisModule_ZsetLastInLexRange", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ZsetLastInLexRange)));
    _ = RedisModule_GetApi.?(c"RedisModule_ZsetRangeCurrentElement", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ZsetRangeCurrentElement)));
    _ = RedisModule_GetApi.?(c"RedisModule_ZsetRangeNext", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ZsetRangeNext)));
    _ = RedisModule_GetApi.?(c"RedisModule_ZsetRangePrev", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ZsetRangePrev)));
    _ = RedisModule_GetApi.?(c"RedisModule_ZsetRangeEndReached", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ZsetRangeEndReached)));
    _ = RedisModule_GetApi.?(c"RedisModule_HashSet", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_HashSet)));
    _ = RedisModule_GetApi.?(c"RedisModule_HashGet", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_HashGet)));
    _ = RedisModule_GetApi.?(c"RedisModule_IsKeysPositionRequest", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_IsKeysPositionRequest)));
    _ = RedisModule_GetApi.?(c"RedisModule_KeyAtPos", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_KeyAtPos)));
    _ = RedisModule_GetApi.?(c"RedisModule_GetClientId", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_GetClientId)));
    _ = RedisModule_GetApi.?(c"RedisModule_GetContextFlags", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_GetContextFlags)));
    _ = RedisModule_GetApi.?(c"RedisModule_PoolAlloc", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_PoolAlloc)));
    _ = RedisModule_GetApi.?(c"RedisModule_CreateDataType", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_CreateDataType)));
    _ = RedisModule_GetApi.?(c"RedisModule_ModuleTypeSetValue", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ModuleTypeSetValue)));
    _ = RedisModule_GetApi.?(c"RedisModule_ModuleTypeGetType", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ModuleTypeGetType)));
    _ = RedisModule_GetApi.?(c"RedisModule_ModuleTypeGetValue", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_ModuleTypeGetValue)));
    _ = RedisModule_GetApi.?(c"RedisModule_SaveUnsigned", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_SaveUnsigned)));
    _ = RedisModule_GetApi.?(c"RedisModule_LoadUnsigned", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_LoadUnsigned)));
    _ = RedisModule_GetApi.?(c"RedisModule_SaveSigned", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_SaveSigned)));
    _ = RedisModule_GetApi.?(c"RedisModule_LoadSigned", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_LoadSigned)));
    _ = RedisModule_GetApi.?(c"RedisModule_SaveString", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_SaveString)));
    _ = RedisModule_GetApi.?(c"RedisModule_SaveStringBuffer", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_SaveStringBuffer)));
    _ = RedisModule_GetApi.?(c"RedisModule_LoadString", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_LoadString)));
    _ = RedisModule_GetApi.?(c"RedisModule_LoadStringBuffer", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_LoadStringBuffer)));
    _ = RedisModule_GetApi.?(c"RedisModule_SaveDouble", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_SaveDouble)));
    _ = RedisModule_GetApi.?(c"RedisModule_LoadDouble", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_LoadDouble)));
    _ = RedisModule_GetApi.?(c"RedisModule_SaveFloat", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_SaveFloat)));
    _ = RedisModule_GetApi.?(c"RedisModule_LoadFloat", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_LoadFloat)));
    _ = RedisModule_GetApi.?(c"RedisModule_EmitAOF", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_EmitAOF)));
    _ = RedisModule_GetApi.?(c"RedisModule_Log", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_Log)));
    _ = RedisModule_GetApi.?(c"RedisModule_LogIOError", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_LogIOError)));
    _ = RedisModule_GetApi.?(c"RedisModule_StringAppendBuffer", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_StringAppendBuffer)));
    _ = RedisModule_GetApi.?(c"RedisModule_RetainString", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_RetainString)));
    _ = RedisModule_GetApi.?(c"RedisModule_StringCompare", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_StringCompare)));
    _ = RedisModule_GetApi.?(c"RedisModule_GetContextFromIO", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_GetContextFromIO)));
    _ = RedisModule_GetApi.?(c"RedisModule_GetKeyNameFromIO", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_GetKeyNameFromIO)));
    _ = RedisModule_GetApi.?(c"RedisModule_Milliseconds", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_Milliseconds)));
    _ = RedisModule_GetApi.?(c"RedisModule_DigestAddStringBuffer", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DigestAddStringBuffer)));
    _ = RedisModule_GetApi.?(c"RedisModule_DigestAddLongLong", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DigestAddLongLong)));
    _ = RedisModule_GetApi.?(c"RedisModule_DigestEndSequence", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DigestEndSequence)));
    _ = RedisModule_GetApi.?(c"RedisModule_CreateDict", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_CreateDict)));
    _ = RedisModule_GetApi.?(c"RedisModule_FreeDict", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_FreeDict)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictSize", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictSize)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictSetC", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictSetC)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictReplaceC", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictReplaceC)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictSet", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictSet)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictReplace", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictReplace)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictGetC", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictGetC)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictGet", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictGet)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictDelC", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictDelC)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictDel", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictDel)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictIteratorStartC", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictIteratorStartC)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictIteratorStart", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictIteratorStart)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictIteratorStop", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictIteratorStop)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictIteratorReseekC", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictIteratorReseekC)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictIteratorReseek", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictIteratorReseek)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictNextC", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictNextC)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictPrevC", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictPrevC)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictNext", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictNext)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictPrev", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictPrev)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictCompare", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictCompare)));
    _ = RedisModule_GetApi.?(c"RedisModule_DictCompareC", @ptrCast(?*c_void, @ptrCast([*c](?*c_void), &RedisModule_DictCompareC)));
    if ((@ptrToInt(RedisModule_IsModuleNameBusy) != 0) and (RedisModule_IsModuleNameBusy.?(name) != 0)) return 1;
...
pub const __MAC_OS_X_VERSION_MAX_ALLOWED = __MAC_10_14_4;
...
pub const __DARWIN_ALIAS_STARTING_MAC___MAC_10_14_4 = x;
...
pub const __DARWIN_NULL = if (@typeId(@typeOf(0)) == @import("builtin").TypeId.Pointer) @ptrCast([*c]void, 0) else if (@typeId(@typeOf(0)) == @import("builtin").TypeId.Int) @intToPtr([*c]void, 0) else ([*c]void)(0);
...
pub const __DARWIN_ALIAS_STARTING_IPHONE___IPHONE_12_2 = x;
